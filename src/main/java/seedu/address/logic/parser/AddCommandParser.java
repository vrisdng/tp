    ...
    public AddCommand parse(String args) throws ParseException {
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_NAME, PREFIX_PHONE,
                        PREFIX_EMAIL, PREFIX_ADDRESS, PREFIX_TAG, PREFIX_STUDENT_ID, PREFIX_TUTORIAL, PREFIX_TELEGRAM);
        ...
        argMultimap.verifyNoDuplicatePrefixesFor(PREFIX_NAME,
            PREFIX_PHONE, PREFIX_EMAIL, PREFIX_STUDENT_ID, PREFIX_TELEGRAM, PREFIX_ADDRESS);
        ...
        Person person = new Person(name, phone, email, address, tagList, studentId, tutorials, telegram);
