...
public class ListCommandTest {
    ...
    public void execute_listIsNotFiltered_showsSameList() {
        ...
        ListCommand listCommand = new ListCommand(true, true, true, true,
                true, true, true, true);
    ...
    public void execute_listWithSpecificFields_showsFilteredFields() {
        ...
        ListCommand listCommand = new ListCommand(true, true, false,
    ...
    public void execute_updatesFilteredPersonList() {
        ...
        ListCommand listCommand = new ListCommand(true, true, true, true, true,
                true, true, true);
        assertCommandSuccess(listCommand, model, ListCommand.MESSAGE_SUCCESS, expectedModel);
    ...
    public void equals() {
        ...
        ListCommand listCommand1 = new ListCommand(true, true, true, true, true, true, true, true);
        ListCommand listCommand2 = new ListCommand(true, true, true, true, true, true, true, true);
        ListCommand listCommand3 = new ListCommand(false, true, true, true, true, true, true, true);
