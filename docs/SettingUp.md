...
First, **fork** [this](https://github.com/AY2425S2-CS2103T-F14-1/tp) repo, and **clone** the fork into your computer.
...
1. **Learn the design**
   ...
   When you are ready to start coding, we recommend that you get some sense of the overall design by reading about [conTAct’s architecture](DeveloperGuide.md#architecture).
